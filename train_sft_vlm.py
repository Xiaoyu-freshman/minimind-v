...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_path", type=str, default="/media/tom/Data/minimind-v_dataset/sft_data.jsonl")
    parser.add_argument("--images_path", type=str, default="/media/tom/Data/minimind-v_dataset/sft_images")
